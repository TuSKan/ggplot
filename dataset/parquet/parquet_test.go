...
func TestRoundTripMemory(t *testing.T) {
	...
	areas := areaCol.(dataset.Column[float64]).Values() //nolint:errcheck,forcetypeassert // type guaranteed by test setup.
...
func TestMemoryNullHandling(t *testing.T) {
	...
	vals := valCol.(dataset.Column[float64]).Values() //nolint:errcheck,forcetypeassert // type guaranteed by test setup.
	if vals[0] != 1.5 {
...
func TestArrowNullHandling(t *testing.T) {
	...
	xs := xCol.(dataset.Column[float64]).Values() //nolint:errcheck,forcetypeassert // type guaranteed by test setup.
	if xs[0] != 42.0 {
...
func TestBoolRoundTrip(t *testing.T) {
	...
	flags := flagCol.(dataset.Column[bool]).Values() //nolint:errcheck,forcetypeassert // type guaranteed by test setup.
