...
|---|---|
| **Geometries** | Point, Line, Step, Bar, Col, Histogram, Area, Density, Polygon, Rug, HLine, VLine, Segment, Text, BoxPlot, Smooth, Tile, ErrorBar, Crossbar, Linerange, Pointrange, Curve, Violin, Dotplot |
...
| ![Violin](assets/violin.png) | ![Dotplot](assets/dotplot.png) | |
| `geom.Violin` | `geom.Dotplot` | |
