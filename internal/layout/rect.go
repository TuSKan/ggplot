...
// SliceBottom cuts precisely `h` units horizontally from the bottom shrinking upwards.
...
// SliceRight cuts precisely `w` units vertically from the right boundary sliding left.
