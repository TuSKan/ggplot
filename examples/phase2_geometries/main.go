...
func pointExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("x"), aes.Y("y")).
		...
		Labels(ggplot.Title("geom.Point"), ggplot.Subtitle("Scatter plot with random data")).
		Theme("dark")
...
func lineExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("t"), aes.Y("amplitude")).
		...
		Labels(ggplot.Title("geom.Line"), ggplot.Subtitle("Damped sine wave")).
		Theme("minimal")
...
func stepExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("time"), aes.Y("level")).
		...
		Labels(ggplot.Title("geom.Step"), ggplot.Subtitle("Staircase function")).
		Theme("bw")
...
func barExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("fruit"), aes.Y("sales")).
		...
		Labels(ggplot.Title("geom.Col (Bar)"), ggplot.Subtitle("Fruit sales by category")).
		Theme("classic")
...
func histogramExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("score")).
		...
		Labels(ggplot.Title("geom.Histogram"), ggplot.Subtitle("Distribution of test scores")).
		Theme("dark")
...
func areaExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("x"), aes.Y("y")).
		...
		Labels(ggplot.Title("geom.Area"), ggplot.Subtitle("Filled area under sin²(x)")).
		Theme("minimal")
...
func densityExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("value")).
		...
		Labels(ggplot.Title("geom.Density"), ggplot.Subtitle("Kernel density estimation of bimodal data")).
		Theme("bw")
...
func rugExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("x"), aes.Y("y")).
		...
		Labels(ggplot.Title("geom.Rug"), ggplot.Subtitle("Marginal rug marks on scatter plot")).
		Theme("dark")
...
func hlineVlineExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("x"), aes.Y("y")).
		...
		Labels(ggplot.Title("geom.HLine + geom.VLine"), ggplot.Subtitle("Reference lines at y=15, x=10")).
		Theme("minimal")
...
func textExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("x"), aes.Y("y"), aes.Label("label")).
		...
		Layer(geom.Text()).
		Labels(ggplot.Title("geom.Text"), ggplot.Subtitle("Labeled scatter points")).
		Theme("bw")
...
func boxplotExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("group"), aes.Y("score")).
		...
		Labels(ggplot.Title("geom.Boxplot"), ggplot.Subtitle("Three treatment groups")).
		Theme("classic")
...
func smoothExample(dir string) {
	...
	p := ggplot.New(ds, aes.X("x"), aes.Y("y")).
		...
		Labels(ggplot.Title("geom.Smooth"), ggplot.Subtitle("LOESS smooth over noisy sine")).
		Theme("dark")
